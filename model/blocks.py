...
class MultiheadAttentionBlock(nn.Module):
    ...
    def __init__(self, d, h, rff):
        ...
        self.multihead = nn.MultiheadAttention(d, h)
    ...
    def forward(self, x, y, s=None):
        ...
        Arguments:
            ...
            s: a bool tensor with shape [n, max_seq_length]. (by Maven Hyun)
        Returns:    
            a float tensor with shape [b, n, d].
        """
        # h = self.layer_norm1(x + self.multihead(x, y, y))
        x, y, = x.transpose(0,1), y.transpose(0,1)
        h = self.layer_norm1(x + self.multihead(x, y, y, key_padding_mask=s)[0])
        return self.layer_norm2(h + self.rff(h)).transpose(0,1)
...
class PoolingMultiheadAttention(nn.Module):
    ...
    def forward(self, z, t=None):
        ...
        Arguments:
            ...
            t: a bool tensor with shape [n, max_seq_length]. (by Maven Hyun)
        Returns:
